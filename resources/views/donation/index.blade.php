...
@php
    ...
    $supporterFeatures = [
        ...
        ["check" => true, "icon" => "fa-solid fa-shield-halved", "text" => "Blok (ban) muddati 10% ga tezroq yechiladi"],
    ...
    $premiumFeatures = [
        ...
        ["check" => true, "icon" => "fa-solid fa-face-smile", "text" => "Global chatda Telegram-style stikerlar"],
        ["check" => true, "icon" => "fa-solid fa-shield-halved", "text" => "Blok (ban) muddati 25% ga tezroq yechiladi"],
    ...
    $vipFeatures = [
        ...
        ["check" => true, "icon" => "fa-solid fa-face-smile", "text" => "Global chatda Telegram-style stikerlar"],
        ["check" => true, "icon" => "fa-solid fa-shield-halved", "text" => "Blok (ban) muddati 45% ga tezroq yechiladi"],
        ["check" => true, "icon" => "fa-solid fa-bolt", "text" => "Sahifalar orasida tezkor o'tish"],
        ["check" => true, "text" => "Maxsus profil dizayni"],
        ["check" => true, "text" => __('public.donation.index_top_donors') . ' ro\'yhati'],

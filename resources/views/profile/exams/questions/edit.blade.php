...
<div class="row">
  <div class="col-lg-12">
    <div class="exam-public-card mb-30">
      ...
      <form method="POST" action="{{ route('profile.exams.questions.update', [$exam, $question]) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        @include('profile.exams.questions.partials.form', ['question' => $question])
      </form>
    </div>
  </div>
</div>

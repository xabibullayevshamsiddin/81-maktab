...
<x-layouts.main :title="__('profile.page_title')">
  @include('profile.partials.header', ['activePanel' => $profilePanel])

  <main class="profile-main" data-profile-i18n='@json($profileI18n)' data-active-panel="{{ $profilePanel }}" style="padding-top: 0;">
    <div class="container">

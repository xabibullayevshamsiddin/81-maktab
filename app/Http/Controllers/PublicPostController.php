        ...
        if ($request->wantsJson()) {
            ...
            return response()->json([
                ...
                'comment' => [
                    ...
                    'donor_rank' => $comment->user?->isDonor() ? $comment->user->donation_rank : null,
                    ...
                    'name_font_weight' => $comment->user?->donorNameFontWeight() ?? '700',
                    'name_font_family' => $comment->user?->donorNameFontFamily() ?? '',
                    'likes_count' => 0,
